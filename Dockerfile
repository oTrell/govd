...
RUN --mount=type=cache,id=s/32db8230-fcef-4237-92fd-0fd1a2369dd5-var-cache-apk-runtime,target=/var/cache/apk,sharing=locked \
    --mount=type=cache,id=s/32db8230-fcef-4237-92fd-0fd1a2369dd5-var-lib-apk-runtime,target=/var/lib/apk,sharing=locked \
    apk add --no-cache \
        --repository="https://dl-cdn.alpinelinux.org/alpine/edge/main" \
        --repository="https://dl-cdn.alpinelinux.org/alpine/edge/community" \
        "ffmpeg=8.0.1-r3" \
